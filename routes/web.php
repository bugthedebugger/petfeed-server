...
Route::post('/login', 'RegistrationController@login')
	->name('user.login');
Route::post('/treat', 'FeedingController@treat')
	->name('user.treat');
...
Route::get('/test', 'RegistrationController@test')
	->name('user.test');
Route::get('/test/register', 'RegistrationController@register')
	->name('user.register.test');
Route::get('/test/login', 'RegistrationController@login')
...
Route::get('/test/get/status', 'SchedulesController@getStatus')
	->name('user.test.get.status');
